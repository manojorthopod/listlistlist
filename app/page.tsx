          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            {PLATFORMS.map((p) => (
              <div
                ...
                title={p.name}
              >
                {/* Colour dot — greyscale by default, full colour on hover */}
                <span
                  ...
                  onMouseEnter={(e) => { (e.currentTarget as HTMLSpanElement).style.background = p.color }}
                  onMouseLeave={(e) => { (e.currentTarget as HTMLSpanElement).style.background = '#44445A' }}
                />
